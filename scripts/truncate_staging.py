#!/usr/bin/env python
"""
truncate_staging.py — Truncate all staging tables.

Idempotent cleanup script. Use before re-running parse_csv.
...
Usage (in-pod via spark-submit):
    spark-submit scripts/truncate_staging.py
